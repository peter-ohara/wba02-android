...
public class QuestionTemplates {
    ...
    private static String mcqDiv =
            "<div class=\"questionKey-page\">\n" +
                    ...
                    "    </div>\n" +
                    "</div>\n" +
                    "<input type=\"button\" value=\"Discussion\" onClick=\"openDiscussionScreen()\" />\n" +
                    "\n" +
                    "<script type=\"text/javascript\">\n" +
                    "    function openDiscussionScreen() {\n" +
                    "        Android.openDiscussionScreen();\n" +
                    "    }\n" +
                    "</script>";
    ...
    public static String headerTemplate = MessageFormat.format(index, css, headerDiv);
}
